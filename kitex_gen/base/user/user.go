...
type User struct {
	...
	PhoneNumber string `thrift:"phone_number,4" frugal:"4,default,string" json:"phone_number"`
...
func (p *Account) GetUserId() (v string) {
	return p.UserId
}
...
func (p *Account) SetUserId(val string) {
	p.UserId = val
}
