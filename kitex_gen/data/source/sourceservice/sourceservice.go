...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"GetItem": kitex.NewMethodInfo(
		getItemHandler,
		newSourceServiceGetItemArgs,
		newSourceServiceGetItemResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
...
func getItemHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*source.SourceServiceGetItemArgs)
	realResult := result.(*source.SourceServiceGetItemResult)
	success, err := handler.(source.SourceService).GetItem(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newSourceServiceGetItemArgs() interface{} {
	return source.NewSourceServiceGetItemArgs()
}

func newSourceServiceGetItemResult() interface{} {
	return source.NewSourceServiceGetItemResult()
}
...
func (p *kClient) GetItem(ctx context.Context, req *source.GetItemRequest) (r *source.GetItemResponse, err error) {
	var _args source.SourceServiceGetItemArgs
	_args.Req = req
	var _result source.SourceServiceGetItemResult
...
func (p *kClient) CreateFolder(ctx context.Context, req *source.CreateFolderRequest) (r *source.CreateFolderResponse, err error) {
